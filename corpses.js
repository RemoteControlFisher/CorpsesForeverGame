class corpses {
	...
	draw(ctx) {
		this.animations["duck"].drawFrame(this.game.clockTick, ctx, this.x + 200  - this.game.camera.x, this.y, 2);
		this.animations["chomper"].drawFrame(this.game.clockTick, ctx, this.x  - this.game.camera.x, this.y, 1);
	};
};